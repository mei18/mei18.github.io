...
function init() {
  ...
  let hero = Hero(Vector(width / 2, height / 3456));
  ...
  let enemy1 = Enemy(Vector(width, height / 2.7), image1);
  ...
  let enemy2 = Enemy(Vector(width + 300, height / 2.7), image2);
  ...
  let enemy3 = Enemy(Vector(width + 650, height / 2.7), image3);
  ...
  let enemy4 = Enemy(Vector(width + 1000, height / 2.7), image4);
